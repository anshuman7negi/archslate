                ...
                <tbody>
                    {
                        attachedFiles.map((file,index) => (
                            <tr className="border-2 font-normal text-base text-[#0F1420]" key={index}>
                                ...
                                <td>
                                    <img src={profile} alt="profile" className="w-7 h-7 rounded-full my-1 ml-4" />
                                </td>
                                <td className="text-center">{file.date}</td>
                                <td className="text-center">{file.size}</td>
                                {errorMessage && <p className="text-white font-bold absolute bg-gray-600 right-0 top-0 py-3 px-8 rounded-l-full animate-bounce">{errorMessage}</p>}
                            </tr>
                        ))
                    }
                </tbody>
