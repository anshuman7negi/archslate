            ...
            <form className="w-full flex flex-col gap-6" onSubmit={handleFormSubmit}>
                <div className="flex w-full gap-12">
                    <div className="flex flex-col gap-2 w-full">
                        ...
                        <input name="title" type="text" value={formData.title} onChange={handleInputChange} className="border-2 py-1 px-2 rounded-lg font-normal text-lg" />
                    </div>

                    <div className="flex flex-col gap-2 w-full">
                        <label htmlFor="Assign" className="font-medium text-xl">Assign To</label>
                ...
                <div className="flex w-full gap-12">
                    <div className="flex flex-col gap-2 w-full">
                        <label htmlFor="title" className="font-medium text-xl">Due Date</label>
                        <input type="text" name="date" value={formData.date} onChange={handleInputChange} className="border-2 py-1 px-2 rounded-lg font-normal text-lg" />
                    </div>
                ...
                <div className="flex w-full gap-12">
                    ...
                    <div className="flex flex-col gap-2 w-full">
                        <label htmlFor="Assign" className="font-medium text-xl">Who else can view this task?</label>
                ...
                <div className="flex flex-col gap-2 w-full">
                    ...
                    <textarea id="" cols="30" rows="6" name="description" value={formData.description} onChange={handleInputChange} className="border-2 py-1 px-2 rounded-lg font-normal text-lg"></textarea>
                </div>

                <div className="flex gap-2 justify-end">
                    <Link to="/" className="border-black border-2 hover:text-white px-6 py-1 rounded-full font-medium text-lg hover:bg-[#0F1420]">Cancel</Link>
                    <button
                        type='submit'
