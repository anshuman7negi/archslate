    ...
    return (
        <section className="flex bg-white rounded-lg p-6 gap-24">
            <div className="flex flex-col gap-6 w-2/3">
                ...
                <textarea name="post" cols="20" rows="8" onChange={handleTextArea} value={textAreaValue}
                    className="border-2 rounded-md border-[#E5E5E5] p-2"></textarea>
                <button
                    onClick={handleClick}
            ...
            <div className="flex flex-col gap-6">
                ...
                <div className="flex flex-col gap-2">
                    <p
                        ...
                        ${activity.status === "Complete" ? "bg-[#D7FEF0] border-[#21CEAF]" : "bg-[#E5E5E5] border-[#AFB6C0]"}
                        `}>
                        Complete
                    </p>
                    <p
                        ...
                        className={`border-2 text-center px-4 py-1 rounded-full text-[#0F1420] font-normal hover:bg-[#D7FEF0] hover:border-[#21CEAF]
                        ${activity.status === "In Progress" ? "bg-[#D7FEF0] border-[#21CEAF]" : "bg-[#E5E5E5] border-[#AFB6C0]"}
                        `}>
                        In Progress
                    </p>
                    <p
                        ...
                        ${activity.status === "Stuck" ? "bg-[#D1EFFF] border-[#84D1FB]" : "bg-[#E5E5E5] border-[#AFB6C0]"}
                        `}>
                        Stuck
                    </p>
                    <p
                        ...
                        ${activity.status === "Not Started" ? "bg-[#FFDAD2] border-[#FF7B7B]" : "bg-[#E5E5E5] border-[#AFB6C0]"}
                        `}>
                        Not Started
                    </p>
                </div>
